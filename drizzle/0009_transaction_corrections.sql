CREATE TABLE `transaction_corrections` (
  ...
  FOREIGN KEY (`root_event_id`) REFERENCES `financial_events`(`id`),
  FOREIGN KEY (`target_event_id`) REFERENCES `financial_events`(`id`),
  FOREIGN KEY (`reversal_event_id`) REFERENCES `financial_events`(`id`),
  FOREIGN KEY (`replacement_event_id`) REFERENCES `financial_events`(`id`)
);
